...
//Min bil, version 1.0
//--------------------------------------------------------------------------------------
public class MinBil extends JPanel implements Runnable,MouseListener {
    //--------------------------------------------------------------------------------------
//Deklarationer
//--------------------------------------------------------------------------------------
    int x = 900, y = 280,
...
//gas
                ...
                e.getY() <= 530){
            vx = (vx + 1);
            hastighet = (hastighet + 5); //hastighet: hur mkt den ska hoppa per vx (6vx)
            if(vx >= 500){
                hastighet = (5);
                vx = (20);
            }//end if
